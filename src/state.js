...
let state = {
  settings: {
    ...
    titleFont: { family: "sans-serif", size: 14, color: "#1a1a1a", lineHeight: 1.0, ...(_cfg.titleFont || {}) },
    contentFont: { family: "sans-serif", size: 12, color: "#1a1a1a", lineHeight: 1.1, ...(_cfg.contentFont || {}) },
